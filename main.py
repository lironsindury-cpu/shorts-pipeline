...
def generate_metadata(transcript, video_name):
    ...
    prompt = f"""You are a YouTube Shorts growth expert specializing in viral IShowSpeed-style quiz content.

Based on this video transcript: "{transcript}"
And video file name: "{video_name}"

Generate metadata for maximum viral reach on YouTube Shorts:
1. A short punchy viral TITLE (max 60 characters, hype energy, MUST end with #shorts)
   Example: "Can You Answer This? 🧠 #shorts"
2. A compelling DESCRIPTION (2-3 sentences, energetic tone, ends with #shorts #quiz #ishowspeed)
3. Exactly 15 YouTube TAGS (mix of: quiz, shorts, ishowspeed, trivia, challenge, viral, and topic-specific tags)

Return ONLY valid JSON, no markdown, no explanation:
{{
  "title": "... #shorts",
  "description": "... #shorts #quiz #ishowspeed",
